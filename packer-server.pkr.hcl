...
build {
  ...
  post-processor "vagrant" {
    output = "output/archlinux-server-${var.filesystem}_${legacy_isotime("2006.01.02")}-{{ .Provider }}.box"
  }
}
